...
# This function registers exception handlers for a FastAPI application.
# It is required for each different microservice app to register its own exceptions,
# as registering exceptions to the main app will not propagate to the microservices.
def register_exceptions (_app: FastAPI):

    # Register a handler for BadRequestException
    ...
    # Register a handler for AuthenticationRequiredException
    ...
    # Register a handler for NonAuthenticatedException
